...
class CancelScreensController extends GetxController {
  static CancelScreensController get instance => Get.find();
  @override
  void onInit() {
    super.onInit();
    getAllData(0);
  ...
  Future<void> showDialogSelectDate(context) async {
    ...
    if (results != null && results.isNotEmpty) {
      ...
      if (results.length > 1) {
        ...
        await getDataTransaction(start_date, end_date, 0);
      }
    }
  ...
  RxList<dynamic> itemsCancel = <dynamic>[].obs;
